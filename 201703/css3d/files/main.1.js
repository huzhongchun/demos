!
    function(t) {
        ...
        return i.e = function(t, e) {
            ...
            i.m = t,
            i.c = n,
            i.p = "http://static.im20.com.cn/v1491448622!/show.im20.com.cn/impublic/zwj/built/",
            i(0)
    } ({
        0 : function(t, i, e) { (function(t, i, n) {
            e(15),
                e(1),
                e(2),
                e(8),
                    ...
                    t.Events, {
                                ...
                                s["in"](),
                                    !
                                        function() {
                                            e.e(0,
                                                function(i) {
                                                    var e = [i(21), i(22), i(23)]; (function(i, e, n) {
                                                        a = i,
                                                            o = e,
                                                            r = n,
                                                            t.complete()
                        ...
                        complete: function() {
                            ...
                            function h(t) {
                                ...
                                i = i > 0 ? i - 360 : i;
                                for (var e = 0,
                                         a = l.root.panoDots.children.length; a > e; e++) {
                    ...
                    function(r) {
                        ...
                        var E = function(t, i, e, n) {
                            if (t) {
                                ...
                                for (var p = u(s); o < p.length; o++) a = s[p[o]],
                                    delete s[a.id],
                        ...
                        f.once = function(t, i, e) {
                            ...
                            f.listenToOnce = function(t, i, e) {
                                var n = g(y, {},
                                    i, e, s(this.stopListening, this, t));
                        ...
                        h(P.prototype, f, {
                            ...
                            _routeToRegExp: function(t) {
                                return t = t.replace(j, "\\$&").replace(T, "(?:$1)?").replace(S,
                                    function(t, i) {
                                        return i ? t: "([^/?]+)"
                                    }).replace(x, "([^?]*?)"),
                                    new RegExp("^" + t + "(?:\\?([\\s\\S]*))?$")
                            ...
                            h(Q.prototype, f, {
                                ...
                                navigate: function(t, i) {
                                    ...
                                    if (t = this.decodeFragment(t.replace(B, "")), this.fragment !== t) {
                                        if (this.fragment = t, this._usePushState) this.history[i.replace ? "replaceState": "pushState"]({},
                                            document.title, n);
                                        else {
            ...
            var n, a; (function(e) {
                ...
                !
                    function(o) {
                        ...
                        function y(t) {
                            var i = ""; (t._jt_obj.x || t._jt_obj.y || t._jt_obj.z) && (i += "translate3d(" + I(t._jt_obj.x) + "," + I(t._jt_obj.y) + "," + I(t._jt_obj.z) + ") "),
                        ...
                        function C() {
                            z || (z = document.createElement("div"), z.style.cssText = "border:0 solid; position:absolute; line-height:0px;"),
                        ...
                        function x(t) {
                            t.bezier && (j(t, t.bezier), t.interpolation = M, delete t.bezier),
                            t.through && (j(t, t.through), t.interpolation = U, delete t.through),
                            t.linear && (j(t, t.linear), t.interpolation = Q, delete t.linear)
                        }
                        function j(t, i) {
                        ...
                        e(V.prototype, {
                            ...
                            _update: function(t) {
                                ...
                                this.onUpdate && this.onUpdate.apply(this, this.onUpdateParams);
                                    ...
                                    0 == this.repeatDelay ? (this.curTime = this.startTime + i, this._updateProp()) : (this._updateProp(), this.curTime = this.startTime + i),
                                    this.onUpdate && this.onUpdate.apply(this, this.onUpdateParams),
                        ...
                        e(P.prototype, {
                            ...
                            e(i, {
                                path: function(t) {
                                    x(t);
                                    for (var e, n = t.ease || i.Linear.None,
                                             a = t.step || 1,
                                             o = [], r = 0; a >= r; r++) {
                                        e = n(r / a);
                                        var s = {};
                        ...
                        return n(r.prototype, {
                            ...
                            removeLabel: function(t) {
                                for (var i = this.labels.length,
                                         e = i - 1; e >= 0; e--) {
                                    var n = this.labels[e];
                                    if (t == n.name) return this.labels.splice(e, 1),
                                        this
                                }
                                return this
                            },
                            ...
                            play: function(t) {
                                if (!this.isPlaying) {
                                    for (var i = this.tweens.length,
                                             e = i - 1; e >= 0; e--) this.tweens[e].play();
                                    this._addSelf(),
                                        this.isPlaying = !0,
                            ...
                            pause: function() {
                                if (this.isPlaying) {
                                    for (var t = this.tweens.length,
                                             i = t - 1; i >= 0; i--) this.tweens[i].pause();
                                    this._removeSelf(),
                                        this.isPlaying = !1
                                }
                            },
                            ...
                            clear: function() {
                                for (var t = this.tweens.length,
                                         i = t - 1; i >= 0; i--) this.tweens[i].kill();
                                this.tweens = [],
                                    this.curTime = 0,
                                    this.labels = [],
                                    this.labelTime = 0,
        ...
        24 : function(t, i, e) { (function(i, n, a, o) {
            var r = e(3);
            t.exports = i.extend({},
                i.Events, {
                    isOut: !1,
